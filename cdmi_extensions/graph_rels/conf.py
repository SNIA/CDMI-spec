...
project = 'Graph Relationahips CDMI Extension'
copyright = '2025, SNIA'
author = 'SNIA'
...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{flushleft}
            {\normalsize
                ABSTRACT: This CDMI Extension is intended for developers who are considering a standardized way to add structured relationship metadata into CDMI objects. When multiple compatible implementations are demonstrated and approved by the Technical Working Group, this extension will be incorporated into the CDMI standard.
            }\par
            {\normalsize
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily Graph Rel CDMI Extension \version}}
        \fancyfoot[LE,LO]{{\py@HeaderFamily \copyright \  SNIA 2025}}
