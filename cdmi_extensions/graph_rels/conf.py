...
project = 'Graph Relationships CDMI Extension'
copyright = '2026, SNIA'
author = 'SNIA'
...
latex_maketitle = r'''
    \begin{titlepage}
        \begingroup % for PDF information dictionary
           ...
           \hypersetup{pdfauthor={SNIA}, pdftitle={CDMI Extension}}%
        \endgroup
        ...
        \begin{center}
            ...
            \vspace{25pt}
            \vspace{36pt}
            {\huge SNIA CDMI\texttrademark{} (Cloud Data Management Interface) }\par
            \vspace{10pt}
            {\Huge Graph Relationships CDMI Extension }\par
            \vspace{10pt}
            {\itshape\Large For CDMI Version 2.0.0}\par
            \vspace{25pt}
        \end{center}
        \begin{flushleft}
            {\normalsize
                ABSTRACT: This CDMI Extension is intended for developers who are considering a standardized way to add structured relationship metadata to CDMI objects. When multiple compatible implementations are demonstrated and approved by the Technical Working Group, this extension will be incorporated into the CDMI standard.
            }\par
            {\normalsize
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily Graph Relationships CDMI Extension \version}}
        \fancyfoot[LE,LO]{{\py@HeaderFamily \copyright \  SNIA 2026}}
...
latex_documents = [
    (master_doc, 'graph_rel_2.0.0.tex', 'Graph Relationships CDMI Extension 2.0.0',
     'SNIA Working Draft', 'manual'),
]

latex_logo = './images/snia_logo_new.pdf'
...
texinfo_documents = [
    (master_doc, 'graph_rel_2.0.0', 'Validators CDMI Extension',
     author, 'graph_rel_2.0.0', 'CDMI Extension',
     'Miscellaneous'),
]
