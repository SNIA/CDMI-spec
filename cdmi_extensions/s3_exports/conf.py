...
project = 'S3 Exports CDMI Extension'
copyright = '2024, SNIA'
author = 'SNIA'
...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \sphinxlogo
            \vspace{36pt}
            {\Huge S3 Exports CDMI Extension }\par
            {\Huge  }\par
            \vspace{10pt}
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily S3 Exports CDMI Extension \version}}
...
latex_documents = [
    (master_doc, 's3_exports_2.0.0.tex', 'S3 Exports CDMI Extension 2.0.0',
