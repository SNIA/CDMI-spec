...
project = 'Capabilities Selection CDMI Extension'
copyright = '2020, SNIA'
author = 'SNIA'
...
htmlhelp_basename = 'capabilities_selection_doc'
...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \sphinxlogo
            \vspace{36pt}
            {\Huge Capabilities Selection CDMI Extension }\par
            {\Huge  }\par
            \vspace{10pt}
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily Capabilities Selection CDMI Extension \version}}
...
latex_documents = [
    (master_doc, 'capabilities_selection_2.0.tex', 'Capabilities Selection CDMI Extension 2.0',
...
texinfo_documents = [
    (master_doc, 'capabilities_selection_2.0', 'Capabilities Selection CDMI Extension',
     author, 'capabilities_selection_2.0', 'CDMI Extension',
     'Miscellaneous'),
]
