...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily Jobs CDMI Extension \version}}
...
latex_documents = [
    (master_doc, 'jobs_2.0.tex', 'Jobs CDMI Extension 2.0',
...
texinfo_documents = [
    (master_doc, 'jobs_2.0', 'Jobs CDMI Extension',
     author, 'jobs_2.0', 'CDMI Extension',
     'Miscellaneous'),
]
