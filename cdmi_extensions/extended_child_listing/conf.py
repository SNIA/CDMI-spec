...
project = 'Extended Child Listing CDMI Extension'
copyright = '2021, SNIA'
author = 'SNIA'
...
htmlhelp_basename = 'extended_child_listing_doc'
...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \sphinxlogo
            \vspace{36pt}
            {\Huge Extended Child Listing CDMI Extension }\par
            {\Huge  }\par
            \vspace{10pt}
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily Extended Child Listing CDMI Extension \version}}
...
latex_documents = [
    (master_doc, 'extended_child_listing_2.0.tex', 'Extended Child Listing CDMI Extension 2.0',
...
texinfo_documents = [
    (master_doc, 'extended_child_listing_2.0', 'Extended Child Listing CDMI Extension',
     author, 'Extended_child_listing_2.0', 'CDMI Extension',
     'Miscellaneous'),
]
