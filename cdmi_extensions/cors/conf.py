...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily CORS CDMI Extension \version}}
...
latex_documents = [
    (master_doc, 'cors_2.0.tex', 'CORS CDMI Extension 2.0',
...
texinfo_documents = [
    (master_doc, 'cors_2.0', 'CORS CDMI Extension',
     author, 'cors_2.0', 'CDMI Extension',
     'Miscellaneous'),
]
