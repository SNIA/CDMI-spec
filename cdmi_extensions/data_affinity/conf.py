...
project = 'Data Affinity CDMI Extension'
copyright = '2020, SNIA'
author = 'SNIA'
...
htmlhelp_basename = 'data_affinity_doc'
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily Data Affinity CDMI Extension \version}}
...
latex_documents = [
    (master_doc, 'data_affinity_2.0.tex', 'Data Affinity CDMI Extension 2.0',
